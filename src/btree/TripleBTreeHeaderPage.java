...
//import btree.*;
  ...
  /**
   * Interface of a triple B+ tree index header page.  
   ...
   */
class TripleBTreeHeaderPage extends THFPage {
   ...
   */
  public TripleBTreeHeaderPage(PageId pageno) 
  ...
  public TripleBTreeHeaderPage(Page page) {
