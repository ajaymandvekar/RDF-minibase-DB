 ...
 * @throws IOException 
   ...
   public Triple(byte [] atriple, int offset,int length) throws IOException
   {
	   data = atriple;
 ...
 * @throws IOException 
    * 
    */
   public Triple(Triple atriple) throws IOException
   {
       data = atriple.getTripleByteArray();
       triple_length = atriple.getLength();
       triple_offset = 0;
       setConfidence(atriple.getConfidence());
       setSubjectID(atriple.getSubjectID());
       setPredicateID(atriple.getPredicateID());
       setObjectID(atriple.getObjectID());
       Subject.writeToByteArray(data,0);
	   Predicate.writeToByteArray(data,8);
	   Object.writeToByteArray(data,16);
	   Convert.setDoubleValue(atriple.getConfidence(),24,data);
   ...
   public void tripleCopy(Triple fromTriple)
   {
	   try{
		   ...
		   Subject = fromTriple.getSubjectID();
		   Predicate = fromTriple.getPredicateID();
		   Object = fromTriple.getObjectID();
		   Value = fromTriple.getConfidence();
	   }
	   catch (Exception e) {
		System.out.println("Error in triple copy");
	} 
   }
