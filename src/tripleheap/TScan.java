...
public class TScan implements GlobalConst{
     ...
     */
    private TID datapageRid = new TID();
	   ...
	   IOException
  {
    ...
    try {
      recptrtriple = datapage.getRecord(rid);
    }
  ...
  //    System.err.println("SCAN: Error in Scan" + e);
     ...
     *			false otherwise.
     */
  public boolean position(TID rid) 
    throws InvalidTripleSizeException,
	   IOException
  { 
    TID    nxtrid = new TID();
   ...
   */
  private boolean mvNext(TID rid) 
    throws InvalidTripleSizeException,
	   IOException
  {
    TID nextrid;
